                ...
                <AnimationContainer delay={0.1}>
                    <div className="flex flex-col items-start justify-start md:max-w-[200px]">
                        ...
                        <span className="mt-4 text-neutral-200 text-sm flex items-center">
                           Créé par  <Link href="https://www.laurentremond.com" className="font-semibold ml-1">Laurent Remond</Link>
                        </span>
                    </div>
                </AnimationContainer>
                        ...
                        <AnimationContainer delay={0.2}>
                            <div className="">
                                ...
                                <ul className="mt-4 text-sm text-muted-foreground">
                                    <li className="mt-2">
                                        <Link href="#template" className="hover:text-foreground transition-all duration-300">
                                            Templates
                                        </Link>
                                    </li>
                                    <li className="mt-2">
                                        <Link href="#tarifs" className="hover:text-foreground transition-all duration-300">
                                            Tarifs
                                        </Link>
                                    </li>
                                    <li className="mt-2">
            ...
            <div className="mt-8 border-t border-border/40 pt-4 md:pt-8 md:flex md:items-center md:justify-between w-full">
                <AnimationContainer delay={0.6}>
                    <p className="text-sm text-muted-foreground mt-8 md:mt-0">
                        &copy; {new Date().getFullYear()} Appliq.fr All rights reserved.
                    </p>
                </AnimationContainer>
            </div>

            <div className="h-[20rem] lg:h-[20rem] hidden md:flex items-center justify-center">
                <TextHoverEffect text="APPLIQ" />
            </div>
        </footer>
    )
}
