	...
	try {
		...
		switch (event.type) {
			case "checkout.session.completed":
				console.log("session ID:", (event.data.object as Stripe.Checkout.Session).id);
				console.log("clé utilisée:", process.env.STRIPE_SECRET_KEY);
				...
				console.log("customerDetails.type " + customerDetails)
